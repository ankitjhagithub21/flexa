...
const BlogCompo = ({url,date,title,desc}) => {
  return (
    <div className="p-4 md:w-1/3">
              <div className="h-full shadow-lg overflow-hidden bg-white client">
                <img
                ...
                />
                <div className="p-6">
                  <h5 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">
                    {date}
                  </h5>
