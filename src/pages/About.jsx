...
import aboutBoxes from '../api/AboutApi';
      ...
      <div className="container mx-auto flex py-24 lg:pl-4 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-5 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <p className="mb-8 leading-relaxed">
            At Flexa, we take pride in our 15-year journey of excellence. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Natus reiciendis qui veritatis in dolores ea id quia eos minima. Odio esse ut libero.
          </p>
